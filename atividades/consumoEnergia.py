...
print("O resultado do seu consumo do mês sendo RS{:.2f} do valor do consumo, RS{:.2f} de ICMS dando um total de R${:.2f}" .format(acrescimo_kw, consumo_icms, consumo_total))